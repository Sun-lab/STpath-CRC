#
# STPath-COAD: CARD Deconvolution for HEST Dataset
# ===============================================
#
# This script performs CARD deconvolution specifically for HEST-1K dataset.
#
# Author: Saishi Cui
# Date: Sept 2025
#
# Purpose: Apply CARD deconvolution method to HEST histopathology dataset
# for cell type proportion estimation.
#
...
sc_count_SelectedGenes <- read.csv('/Users/scui2/ST/scRNAseq_data/InputDf_for_CARD_SelectedGenes.csv', header = TRUE, sep = ",")
...
sc_meta <- read.csv('/Users/scui2/ST/scRNAseq_data/InputDf_for_CARD_meta.csv', header = TRUE, sep = ",")
...
run_deconvolution <- function(expression_file, spatial_file, sc_count, sc_meta, sample_name) {
  ...
  CARD_obj_file_name <- paste0("/Users/scui2/ST/hest_data/CARD_Results/", sub("_expression$", "", tools::file_path_sans_ext(basename(expression_file))), "_cardobj_modified.rds")
  Celltype_file_name <- paste0("/Users/scui2/ST/hest_data/CARD_Results/", sub("_expression$", "", tools::file_path_sans_ext(basename(expression_file))), "_celltype_proportion_modified.csv")
  B_Matrix_file_name <- paste0("/Users/scui2/ST/hest_data/CARD_Results/", sub("_expression$", "", tools::file_path_sans_ext(basename(expression_file))), "_B_Matrix_modified.csv")
  Basis_file_name <- paste0("/Users/scui2/ST/hest_data/CARD_Results/", sub("_expression$", "", tools::file_path_sans_ext(basename(expression_file))), "_Basis_modified.csv")
...
expression_files <- list.files("/Users/scui2/ST/hest_data/CARD_Need_Files", pattern = "_expression.csv", full.names = TRUE)
spatial_files <- list.files("/Users/scui2/ST/hest_data/CARD_Need_Files", pattern = "_spatial.csv", full.names = TRUE)
