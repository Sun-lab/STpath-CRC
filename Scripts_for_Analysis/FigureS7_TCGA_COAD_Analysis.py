"""
FigureS7 TCGA COAD Analysis Pipeline
=====================================
        ...
        for i, csv_file in enumerate(csv_files, 1):
            ...
            try:
                ...
                for cell_type in merged_groups:
                    ...
                    cbar.set_label('Normalized Proportion', fontsize=14, fontweight='bold')
            ...
            try:
                ...
                for source, target in directional_pairs:
                    ...
                    if len(plot_data_hex) > 0:
                        ...
                        cbar_hex.set_label('Weighted Min Distance (tiles)', fontsize=14, fontweight='bold')
                        cbar_hex.ax.tick_params(labelsize=12)
