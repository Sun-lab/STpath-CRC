...
Conch_pan_APC_Cells_data = torch.load(f = "xgboost_prediction/Other Immune Cells_Conch_individual_level_ratio100/xgboost_results_individual_level.pt")
ProvGigapath_pan_APC_Cells_data = torch.load(f = "xgboost_prediction/Other Immune Cells_ProvGigapath_individual_level_ratio100/xgboost_results_individual_level.pt")
Virchow_pan_APC_Cells_data = torch.load(f = "xgboost_prediction/Other Immune Cells_Virchow_individual_level_ratio100/xgboost_results_individual_level.pt")
Virchow2_pan_APC_Cells_data = torch.load(f = "xgboost_prediction/Other Immune Cells_Virchow2_individual_level_ratio100/xgboost_results_individual_level.pt")
UNI2h_pan_APC_Cells_data = torch.load(f = "xgboost_prediction/Other Immune Cells_UNI2h_individual_level_ratio100/xgboost_results_individual_level.pt")
...
pickle.dump(Important_Features_pan_APC_Cells, open("xgboost_prediction/important_features_Other Immune Cells.pkl", "wb"))
...
Important_Features_pan_APC_Cells = pickle.load(open("xgboost_prediction/important_features_Other Immune Cells.pkl", "rb"))
...
cell_types_order = ['Cancer_Cells', 'Stromal_Cells', 'Normal_Epithelial_Cells', 'T_Cells', 'pan_APC_Cells']
cell_types_data = {
